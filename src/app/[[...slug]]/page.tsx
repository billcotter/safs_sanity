...
async function FallbackHomePage() {
  return (
    <>
      ...
      {/* Up and Coming Section - Vertical Cards */}
      <div className='container mx-auto px-4 py-8'>
                ...
                <div className='p-4'>
                  ...
                  <div className='space-y-1 text-sm text-charcoal/70 mb-3'>
                    ...
                    <div className='flex items-center gap-1'>
                      ...
                      <Link
                        href='/films?country=south-korea'
                ...
                <div className='p-4'>
                  ...
                  <div className='flex gap-2'>
                    <Button
                      ...
                      size='sm'
                      icon={Film}
                      href='/films/the-french-dispatch'
                      className='flex-1'
                    >
                      Film Details
                    </Button>
                    <Button
                      ...
                      size='sm'
                      icon={Ticket}
                      href='/purchase?film=the-french-dispatch'
                      className='flex-1'
                    >
                      Buy Tickets
                    </Button>
      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center mb-8'>
          ...
          <p className='text-charcoal/70 mb-6'>
            ...
            >
              Check out our Film Archive here
            </Link>
          </p>
        </div>
